...
class CompletedAdoptionReport extends ConsumerStatefulWidget {
  ...
  const CompletedAdoptionReport({required this.ngoEmail, super.key});
...
class _PendingAdoptionReportState
    extends ConsumerState<CompletedAdoptionReport> {
                              ...
                              child: ListTile(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => ClosedAdoptionPost(
