...
import 'package:stray_animals_ui/screens/ngo_screens/events/ngo_event_screen.dart';
import '../../../models/event_model.dart';
import '../../../repositories/places_services.dart';
import 'package:http/http.dart' as http;

class NGOUpcomingEvents extends ConsumerStatefulWidget {
  final String ngoEmail;
  const NGOUpcomingEvents({required this.ngoEmail, super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _NGOUpcomingEventsState();
}

class _NGOUpcomingEventsState extends ConsumerState<NGOUpcomingEvents> {
  List<Event> events = [];
  @override
  ...
  Future<List<Event>> getItems() async {
    ...
    events = items.where((element) => element.status == false).toList();
    return items;
  }
}
