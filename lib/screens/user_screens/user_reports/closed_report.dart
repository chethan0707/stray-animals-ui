...
class ClosedReport extends ConsumerStatefulWidget {
...
class _NGOReportState extends ConsumerState<ClosedReport> {
  @override
      ...
      body: Column(
        children: [
          ...
          widget.report.volunteer == null || widget.report.volunteer!.isEmpty
              ? const Text("Status: Volunteer not assigned")
              : InkWell(
                  onTap: () {
                                    ...
                                    onTap: () {
                                      Navigator.of(context)
                                        ...
                                        builder: (context) => PhotoViewComp(
                                            url: widget.volunteer!.profileUrl!),
                                      ));
                                    },
                                    child: ClipRRect(
                  ...
                  child: Text(
                      "Status: Volunteer assigned \n Volunteer:  ${widget.volunteer!.userName}"),
                ),
        ],
      ),
    );
