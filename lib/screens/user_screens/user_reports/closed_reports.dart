...
import 'package:stray_animals_ui/screens/user_screens/user_reports/closed_report.dart';

import '../../../models/volunteer.dart';
import '../../../repositories/places_services.dart';

class ClosedReportList extends ConsumerStatefulWidget {
  final String userEmail;

  const ClosedReportList({required this.userEmail, super.key});
...
class _OpenReportsListState extends ConsumerState<ClosedReportList> {
          ...
          return newReports.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return newReports[index].status == true
                        ? Padding(
  ...
  Future<List<UserReport>> getUserReports() async {
    ...
    newReports = items.where((element) => element.status == true).toList();
    return newReports;
  }
